...
// Source: ../svc/shop/internal/usecase/usecase.go
...
import (
	...
	entity "github.com/reyhanfahlevi/poc-test/svc/shop/internal/entity"
)
...
func (m *MockrepoInterface) Get(ctx context.Context, param entity.ParamGetShop) ([]entity.Shop, error) {
	m.ctrl.T.Helper()
...
func (m *MockrepoInterface) Save(ctx context.Context, data entity.ParamSaveShop) error {
	m.ctrl.T.Helper()
