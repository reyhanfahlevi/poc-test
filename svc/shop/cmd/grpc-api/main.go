...
import (
	...
	"github.com/reyhanfahlevi/poc-test/svc/shop/app/grpc"
	"github.com/reyhanfahlevi/poc-test/svc/shop/internal/repo"
	"github.com/reyhanfahlevi/poc-test/svc/shop/internal/usecase"
)
...
func main() {
	...
	err := config.Init(config.WithConfigFile("files/etc/shop/config.json", "/etc/shop/config.json"))
	if err != nil {
		log.Fatal(err)
	}
